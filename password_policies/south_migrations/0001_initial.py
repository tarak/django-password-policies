...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'password_policies_passwordchangerequired', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='password_change_required', unique=True, to=orm['auth.User'])),
        ))
        ...
        db.create_table(u'password_policies_passwordhistory', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='password_history_entries', to=orm['auth.User'])),
        ))
